...
public class MenuComponent extends AbstractComponent {
     ...
     *
     * @param menu 菜单对象
     * @throws org.weixin4j.exception.WeixinException 微信操作异常 创建自定义菜单异常
     */
     ...
     *
     * @return 自定义菜单对象
     * @throws org.weixin4j.exception.WeixinException 微信操作异常 查询自定义菜单对象异常
     */
     ...
     * 删除自定义菜单
     *
     * @throws org.weixin4j.exception.WeixinException 微信操作异常 删除自定义菜单异常
     */
