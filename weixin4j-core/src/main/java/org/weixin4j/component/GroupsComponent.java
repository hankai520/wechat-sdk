...
public class GroupsComponent extends AbstractComponent {
     ...
     * @throws org.weixin4j.exception.WeixinException 创建分组异常
     */
     ...
     *
     * @return 分组列表
     * @throws org.weixin4j.exception.WeixinException 查询所有分组异常
     */
     ...
     * @return 返回用户所在分组Id
     * @throws org.weixin4j.exception.WeixinException 查询用户所在分组异常
     */
     ...
     * @param id 分组id，由微信分配
     * @param name 分组名字（30个字符以内）
     * @throws org.weixin4j.exception.WeixinException 修改分组名异常
     */
     ...
     *
     * @param groupId 分组Id
     * @throws org.weixin4j.exception.WeixinException 删除分组异常
     */
     ...
     * @throws org.weixin4j.exception.WeixinException 移动用户分组异常
     */
