...
public class Attachment {
   ...
   */
  public void setFileStream(final BufferedInputStream fileStream) {
   ...
   */
  public File saveToImageFile(final String filePath, String fileName) throws FileNotFoundException, IOException {
   ...
   * @throws IOException 文件I/O异常
   */
  public File saveToFile(String filePath, final String fileName, final String defaultSubffix)
    ...
    if (this.error == null) {
      ...
      final File file = new File(filePath + fileName + (subffix.indexOf(".") == 0 ? subffix : "." + subffix));
